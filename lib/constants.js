...
const OPERATORS = [
  ...
  //   fullIndex: '',
  //   gadget: [
  //     { id: type => `operator${type}_warden_XXX`, name: 'Kills While Using Glance' }
  //   ]
  // },
  // {
  //   name: 'nokk',
  ...
  //   fullIndex: '',
  //   gadget: [
  //     { id: type => `operator${type}_nokk_XXX`, name: 'Observation Tools Deceived' }
  //   ]
  // }
];
...
const RANKS = {
  20: { name: 'Diamond', badge: 'BPTsruE' },
  19: { name: 'Platinum 1', badge: 'vM99U2X' },
  18: { name: 'Platinum 2', badge: 'BWZntMj' },
  17: { name: 'Platinum 3', badge: '6AE1DeN' },
  16: { name: 'Gold 1', badge: 'YSMXwwj' },
  15: { name: 'Gold 2', badge: 'XmoIXvX' },
  14: { name: 'Gold 3', badge: 'ua1gXAC' },
  13: { name: 'Gold 4', badge: 'rrPfwSc' },
  12: { name: 'Silver 1', badge: '5oHNIK6' },
  11: { name: 'Silver 2', badge: 'fCzjRiu' },
  10: { name: 'Silver 3', badge: 'BtHkA3t' },
  9: { name: 'Silver 4', badge: '9YKfOUm' },
  8: { name: 'Bronze 1', badge: 'UL72TCz' },
  7: { name: 'Bronze 2', badge: 'ScN2Nq7' },
  6: { name: 'Bronze 3', badge: 'y9S2Dxp' },
  5: { name: 'Bronze 4', badge: 's7WbWgP' },
  4: { name: 'Copper 1', badge: 'N0Ni07K' },
  3: { name: 'Copper 2', badge: 'piH6pb4' },
  2: { name: 'Copper 3', badge: 'ngBCfAK' },
  1: { name: 'Copper 4', badge: 'yDpq16S' },
  0: { name: 'Unranked', badge: 'bvnVUEm' }
};

// const RANKS = {
//   20: { name: 'Diamond', oldbadge: 'BPTsruE', badge: '' },
//   19: { name: 'Platinum 1', oldbadge: 'vM99U2X', badge: '' },
//   18: { name: 'Platinum 2', oldbadge: 'BWZntMj', badge: '' },
//   17: { name: 'Platinum 3', oldbadge: '6AE1DeN', badge: '' },
