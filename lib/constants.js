...
const WEAPONS = [
  // assault
  { name: 'L85A2', id: 'B79310C6', category: 'assault', image: 'https://liquipedia.net/commons/images/7/78/R6S_wpn_L85A2.png' },
  { name: 'F2', id: '9B2CA14F', category: 'assault', image: 'https://liquipedia.net/commons/images/f/ff/R6S_wpn_F2.png' },
  { name: '416-C CARBINE', id: '106FE714D', category: 'assault', image: 'https://liquipedia.net/commons/images/5/56/R6S_wpn_416-C_Carbine.png' },
  { name: 'R4-C', id: 'B79310D2', category: 'assault', image: 'https://liquipedia.net/commons/images/3/35/R6S_wpn_R4-C.png' },
  { name: '556XI', id: 'B79310D4', category: 'assault', image: 'https://liquipedia.net/commons/images/c/c7/R6S_wpn_556XI.png' },
  { name: 'Type-89', id: '9A25C4B26', category: 'assault', image: 'https://liquipedia.net/commons/images/7/72/R6S_wpn_TYPE-89.png' },
  { name: '552 Commando', id: 'B79310D3', category: 'assault', image: 'https://liquipedia.net/commons/images/c/c0/R6S_wpn_552_Commando.png' },
  { name: 'PARA-308', id: '8ACBED9B8', category: 'assault', image: 'https://liquipedia.net/commons/images/c/cd/R6S_wpn_PARA-308.png' },
  { name: 'AR33', id: 'B79310D8', category: 'assault', image: 'https://liquipedia.net/commons/images/2/22/R6S_wpn_AR33.png' },
  { name: 'G36C', id: 'B79310DE', category: 'assault', image: 'https://liquipedia.net/commons/images/7/7b/R6S_wpn_G36C.png' },
  { name: 'C8-SFW', id: '2CEABF00B', category: 'assault', image: 'https://liquipedia.net/commons/images/d/d3/R6S_wpn_C8-SFW.png' },
  { name: 'M4', id: '1EFE81B5D5', category: 'assault', image: 'https://liquipedia.net/commons/images/d/dd/R6S_wpn_M4.png' },
  { name: 'M762', id: 'E50FB57FB', category: 'assault', image: 'https://liquipedia.net/commons/images/b/b6/R6S_wpn_M762.png' },
  { name: 'C7E', id: 'A3038BA91', category: 'assault', image: 'https://liquipedia.net/commons/images/9/9c/R6S_wpn_C7E.png' },
  { name: 'AK-12', id: '106FE7150', category: 'assault', image: 'https://liquipedia.net/commons/images/b/b7/R6S_wpn_AK-12.png' },
  { name: 'MK17 CQB', id: '2CEAAA814', category: 'assault', image: 'https://liquipedia.net/commons/images/2/2c/R6S_wpn_MK17_CQB.png' },
  { name: 'AUG A2', id: '9B2CA14A', category: 'assault', image: 'https://liquipedia.net/commons/images/1/16/R6S_wpn_AUG_A2.png' },
  { name: 'v308', id: 'BE9996F2D', category: 'assault', image: 'https://liquipedia.net/commons/images/9/9e/R6S_wpn_V308.png' },
  { name: 'AK-74M', id: '23D027C51C', category: 'assault', image: 'https://liquipedia.net/commons/images/2/2a/R6S_wpn_AK-74M.png' },
  { name: 'Commando 9', id: 'BE998B05E', category: 'assault', image: 'https://liquipedia.net/commons/images/8/8e/R6S_wpn_Commando_9.png' },
  { name: 'AR-15.50', id: '1EFE80F033', category: 'assault', image: 'https://liquipedia.net/commons/images/c/cf/R6S_wpn_AR-15.50.png' },
  { name: 'F90', id: '2902BBFED9', category: 'assault', image: 'https://liquipedia.net/commons/images/a/a1/R6S_wpn_F90.png' },
  { name: 'ARX200', id: '2418EC4362', category: 'assault', image: 'https://liquipedia.net/commons/images/8/84/R6S_wpn_ARX200.png' },
  { name: 'SPEAR .308', id: 'BE99AD3BD', category: 'assault', image: 'https://liquipedia.net/commons/images/b/bb/R6S_wpn_SPEAR_.308.png' },

  // smg
  { name: 'MPX', id: '5BD3A85FC', category: 'smg', image: 'https://liquipedia.net/commons/images/2/2c/R6S_wpn_MPX.png' },
  { name: 'MP7', id: '106FE714F', category: 'smg', image: 'https://liquipedia.net/commons/images/8/80/R6S_wpn_MP7.png' },
  { name: 'MP5', id: 'B79310C1', category: 'smg', image: 'https://liquipedia.net/commons/images/8/89/R6S_wpn_MP5.png' },
  { name: 'UMP45', id: 'B79310CF', category: 'smg', image: 'https://liquipedia.net/commons/images/7/7d/R6S_wpn_UMP45.png' },
  { name: 'Vector .45 ACP', id: 'A3038BA92', category: 'smg', image: 'https://liquipedia.net/commons/images/a/a1/R6S_wpn_Vector_.45_ACP.png' },
  { name: 'M12', id: '8ACBEC5F2', category: 'smg', image: 'https://liquipedia.net/commons/images/1/13/R6S_wpn_M12.png' },
  { name: 'SMG-12', id: '128C51CBED', category: 'smg', image: 'https://liquipedia.net/commons/images/1/13/R6S_wpn_SMG-12.png' },
  { name: 'Scorpion EVO 3 A1', id: 'E50FA8B51', category: 'smg', image: 'https://liquipedia.net/commons/images/5/52/R6S_wpn_Scorpion_EVO_3_A1.png' },
  { name: 'MP5K', id: 'B79310D1', category: 'smg', image: 'https://liquipedia.net/commons/images/5/5f/R6S_wpn_MP5K.png' },
  { name: '9x19VSN', id: '106FE7151', category: 'smg', image: 'https://liquipedia.net/commons/images/a/ae/R6S_wpn_9x19VSN.png' },
  { name: 'P90', id: 'B79310C7', category: 'smg', image: 'https://liquipedia.net/commons/images/0/08/R6S_wpn_P90.png' },
  { name: 'K1A', id: '128C51CBEF', category: 'smg', image: 'https://liquipedia.net/commons/images/8/86/R6S_wpn_K1A.png' },
  { name: '9mm C1', id: '2CEABC77A', category: 'smg', image: 'https://liquipedia.net/commons/images/9/9e/R6S_wpn_9mm_C1.png' },
  { name: 'Mx4 Storm', id: '172522E967', category: 'smg', image: 'https://liquipedia.net/commons/images/d/dd/R6S_wpn_Mx4_Storm.png' },
  { name: 'T-5 SMG', id: 'B699FDA28', category: 'smg', image: 'https://liquipedia.net/commons/images/5/50/R6S_wpn_T-5_SMG.png' },
  { name: 'MP5SD', id: '99EB07773', category: 'smg', image: 'https://liquipedia.net/commons/images/3/33/R6S_wpn_MP5SD.png' },
  { name: 'FMG-9', id: 'B79310D0', category: 'smg', image: 'https://liquipedia.net/commons/images/2/26/R6S_wpn_FMG-9.png' },
  { name: 'AUG A3', id: '2418EC6F2C', category: 'smg', image: 'https://liquipedia.net/commons/images/a/a8/R6S_wpn_AUG_A3.png' },
  { name: 'PDW9', id: 'A3038BA94', category: 'smg', image: 'https://liquipedia.net/commons/images/6/69/R6S_wpn_PDW9.png' },
  { name: 'P10 RONI', id: '2902BB46BB', category: 'smg', image: 'https://liquipedia.net/commons/images/0/06/R6S_wpn_P10_RONI.png' },

  // lmg
  { name: 'ALDA 5.56', id: '172522E96A', category: 'lmg', image: 'https://liquipedia.net/commons/images/7/7b/R6S_wpn_ALDA_5.56.png' },
  { name: 'G8A1', id: '106FE714C', category: 'lmg', image: 'https://liquipedia.net/commons/images/b/bf/R6S_wpn_G8A1.png' },
  { name: '6P41', id: 'B79310DA', category: 'lmg', image: 'https://liquipedia.net/commons/images/4/42/R6S_wpn_6P41.png' },
  { name: 'T-95 LSW', id: 'B699FDA29', category: 'lmg', image: 'https://liquipedia.net/commons/images/6/60/R6S_wpn_T-95_LSW.png' },
  { name: 'LMG-E', id: 'E50FB57FC', category: 'lmg', image: 'https://liquipedia.net/commons/images/7/7a/R6S_wpn_LMG-E.png' },
  { name: 'M249', id: '8ACBE8797', category: 'lmg', image: 'https://liquipedia.net/commons/images/4/4f/R6S_wpn_M249.png' },
  { name: 'M249 SAW', id: '2902BB7B8C', category: 'lmg', image: 'https://liquipedia.net/commons/images/c/c3/R6S_wpn_M249_SAW.png' },

  // marksman
  { name: 'OTs-03', id: '106FE7152', category: 'marksman', image: 'https://liquipedia.net/commons/images/f/f4/R6S_wpn_OTs-03.png' },
  { name: 'CAMRS', id: '2CEAAB41D', category: 'marksman', image: 'https://liquipedia.net/commons/images/4/4d/R6S_wpn_CAMRS.png' },
  { name: 'Mk 14 EBR', id: '128C5259FA', category: 'marksman', image: 'https://liquipedia.net/commons/images/2/26/R6S_wpn_Mk_14_EBR.png' },
  { name: '417', id: 'B79310C0', category: 'marksman', image: 'https://liquipedia.net/commons/images/d/db/R6S_wpn_417.png' },
  { name: 'SR-25', id: '2CEABFB43', category: 'marksman', image: 'https://liquipedia.net/commons/images/f/f7/R6S_wpn_SR-25.png' },
  { name: 'CSRX 300', id: '33E28FCCA0', category: 'marksman', image: 'https://liquipedia.net/commons/images/9/99/R6S_CSRX_300.png' },

  // pistol
  { name: 'M45 MEUSOC', id: 'B79310D7', category: 'pistol', image: 'https://liquipedia.net/commons/images/1/1d/R6S_wpn_M45_MEUSOC.png' },
  { name: 'P12', id: 'B79310CB', category: 'pistol', image: 'https://liquipedia.net/commons/images/9/94/R6S_wpn_P12.png' },
  { name: 'LFP586', id: 'B79310C8', category: 'pistol', image: 'https://liquipedia.net/commons/images/8/81/R6S_wpn_LFP586.png' },
  { name: 'P226 MK 25', id: 'B79310CA', category: 'pistol', image: 'https://liquipedia.net/commons/images/b/bf/R6S_wpn_P226_MK_25.png' },
  { name: 'D-50', id: '53AEC9396', category: 'pistol', image: 'https://liquipedia.net/commons/images/d/d1/R6S_wpn_D-50.png' },
  { name: 'P9', id: 'B79310D9', category: 'pistol', image: 'https://liquipedia.net/commons/images/2/26/R6S_wpn_P9.png' },
  { name: 'PRB92', id: '8ACBEC355', category: 'pistol', image: 'https://liquipedia.net/commons/images/e/e7/R6S_wpn_PRB92.png' },
  { name: 'MK1 9mm', id: '37ACC03F7', category: 'pistol', image: 'https://liquipedia.net/commons/images/9/9c/R6S_wpn_MK1_9mm.png' },
  { name: 'GSH-18', id: '106FE7153', category: 'pistol', image: 'https://liquipedia.net/commons/images/4/4d/R6S_wpn_GSH-18.png' },
  { name: 'PMM', id: '9B2CB308', category: 'pistol', image: 'https://liquipedia.net/commons/images/b/b3/R6S_wpn_PMM.png' },
  { name: 'RG15', id: 'E50FB57FD', category: 'pistol', image: 'https://liquipedia.net/commons/images/a/a8/R6S_wpn_RG15.png' },
  { name: 'Keratos .357', id: '199D70994A', category: 'pistol', image: 'https://liquipedia.net/commons/images/0/0b/R6S_wpn_Keratos_.357.png' },
  { name: 'Q-929', id: 'B699FDA2A', category: 'pistol', image: 'https://liquipedia.net/commons/images/9/91/R6S_wpn_Q-929.png' },
  { name: '.44 Mag Semi-Auto', id: '2418EC5F35', category: 'pistol', image: 'https://liquipedia.net/commons/images/1/10/R6S_wpn_.44_Mag_Semi-Auto.png' },
  { name: '5.7 USG', id: '9B2CA14C', category: 'pistol', image: 'https://liquipedia.net/commons/images/f/f1/R6S_wpn_5.7_USG.png' },
  { name: 'P229', id: '959B5DBD4', category: 'pistol', image: 'https://liquipedia.net/commons/images/1/1c/R6S_wpn_P229.png' },
  { name: 'USP40', id: 'A3038BA93', category: 'pistol', image: 'https://liquipedia.net/commons/images/9/95/R6S_wpn_USP40.png' },
  { name: 'SDP 9mm', id: '2A69013364', category: 'pistol', image: 'https://liquipedia.net/commons/images/f/fd/R6S_wpn_SDP_9mm.png' },
  { name: 'P-10C', id: '1EFE80F702', category: 'pistol', image: 'https://liquipedia.net/commons/images/f/f5/R6S_wpn_P-10C.png' },
  { name: 'Bailiff 410', id: '172522E96B', category: 'pistol', image: 'https://liquipedia.net/commons/images/c/c9/R6S_wpn_Bailiff_410.png' },
  { name: '1911 TACOPS', id: '1EFE81B5D4', category: 'pistol', image: 'https://liquipedia.net/commons/images/d/d6/R6S_wpn_1911_TACOPS.png' },

  // shotgun
  { name: 'M590A1', id: '9B2CA14E', category: 'shotgun', image: 'https://liquipedia.net/commons/images/4/46/R6S_wpn_M590A1.png' },
  { name: 'ITA12S', id: 'A3038BA90', category: 'shotgun', image: 'https://liquipedia.net/commons/images/d/d1/R6S_wpn_ITA12S.png' },
  { name: 'M1014', id: 'B79310CC', category: 'shotgun', image: 'https://liquipedia.net/commons/images/9/98/R6S_wpn_M1014.png' },
  { name: 'M870', id: '106FE714E', category: 'shotgun', image: 'https://liquipedia.net/commons/images/6/69/R6S_wpn_M870.png' },
  { name: 'Super 90', id: '2CEABFF54', category: 'shotgun', image: 'https://liquipedia.net/commons/images/0/0a/R6S_wpn_Super_90.png' },
  { name: 'Supernova', id: '959B746E6', category: 'shotgun', image: 'https://liquipedia.net/commons/images/f/f3/R6S_wpn_SUPERNOVA.png' },
  { name: 'SPAS-15', id: '8ACBEBD23', category: 'shotgun', image: 'https://liquipedia.net/commons/images/5/59/R6S_wpn_SPAS-15.png' },
  { name: 'SG-CQB', id: '9B2CA14B', category: 'shotgun', image: 'https://liquipedia.net/commons/images/b/be/R6S_wpn_SG-CQB.png' },
  { name: 'SIX12', id: 'B699FDA2B', category: 'shotgun', image: 'https://liquipedia.net/commons/images/9/99/R6S_wpn_SIX12.png' },
  { name: 'SASG-12', id: '9B2CB313', category: 'shotgun', image: 'https://liquipedia.net/commons/images/6/68/R6S_wpn_SASG-12.png' },
  { name: 'BOSG.12.2', id: '128C51DEC8', category: 'shotgun', image: 'https://liquipedia.net/commons/images/f/f1/R6S_wpn_BOSG.12.2.png' },
  { name: 'SPAS-12', id: '2CEABF739', category: 'shotgun', image: 'https://liquipedia.net/commons/images/7/7e/R6S_wpn_SPAS-12.png' },
  { name: 'Super Shorty', id: '1EFE80F701', category: 'shotgun', image: 'https://liquipedia.net/commons/images/4/43/R6S_wpn_Super_Shorty.png' },
  { name: 'SIX12 SD', id: 'B699FDA2C', category: 'shotgun', image: 'https://liquipedia.net/commons/images/f/fa/R6S_wpn_SIX12_SD.png' },
  { name: 'FO-12', id: 'E50FB57FA', category: 'shotgun', image: 'https://liquipedia.net/commons/images/0/0a/R6S_wpn_FO-12.png' },
  { name: 'ITA12L', id: 'A3038B5A5', category: 'shotgun', image: 'https://liquipedia.net/commons/images/3/3d/R6S_wpn_ITA12L.png' },
  { name: 'ACS12', id: 'BE99AD3BE', category: 'shotgun', image: 'https://liquipedia.net/commons/images/e/e5/R6S_wpn_ACS12.png' },
  { name: 'TCSG12', id: '2418EC7D3A', category: 'shotgun', image: 'https://liquipedia.net/commons/images/7/77/R6S_wpn_TCSG12.png' },

  // mp
  { name: 'SMG-11', id: 'B79310CE', category: 'mp', image: 'https://liquipedia.net/commons/images/f/fd/R6S_wpn_SMG-11.png' },
  { name: 'Bearing 9', id: '99EB0571E', category: 'mp', image: 'https://liquipedia.net/commons/images/5/5a/R6S_wpn_BEARING_9.png' },
  { name: 'SPSMG9', id: '1EFE81B5D6', category: 'mp', image: 'https://liquipedia.net/commons/images/6/66/R6S_wpn_SPSMG9.png' },
  { name: 'C75 Auto', id: '128C51DEC6', category: 'mp', image: 'https://liquipedia.net/commons/images/1/17/R6S_wpn_C75_Auto.png' },
