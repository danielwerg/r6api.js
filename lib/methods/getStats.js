          ...
          pvp: {
            ...
            modes: {
              ...
              hostage: {
                ...
                played: val['rescuehostagepvp_matchplayed:infinite'],
                matches: val['rescuehostagepvp_bestscore:infinite'],
            ...
            queue: {
              ...
              discovery: {
                name: 'Discovery',
                kills: (val['generalpvp_kills:infinite'] || 0) - ((val['rankedpvp_kills:infinite'] || 0) + (val['casualpvp_kills:infinite'] || 0)),
                deaths: (val['generalpvp_death:infinite'] || 0) - ((val['rankedpvp_death:infinite'] || 0) + (val['casualpvp_death:infinite'] || 0)),
                wins: (val['generalpvp_matchwon:infinite'] || 0) - ((val['rankedpvp_matchwon:infinite'] || 0) + (val['casualpvp_matchwon:infinite'] || 0)),
                losses: (val['generalpvp_matchlost:infinite'] || 0) - ((val['rankedpvp_matchlost:infinite'] || 0) + (val['casualpvp_matchlost:infinite'] || 0)),
                matches: (val['generalpvp_matchplayed:infinite'] || 0) - ((val['rankedpvp_matchplayed:infinite'] || 0) + (val['casualpvp_matchplayed:infinite'] || 0)),
                playtime: (val['generalpvp_timeplayed:infinite'] || 0) - ((val['rankedpvp_timeplayed:infinite'] || 0) + (val['casualpvp_timeplayed:infinite'] || 0))
              }
            }
          },
          pve: {
