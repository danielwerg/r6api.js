...
module.exports = (platform, query, raw = false) => {
  ...
  const discoveryGetter = (obj, type) =>
        ...
        .map(([id, val]) => ({
          ...
          pvp: {
            ...
            queue: {
              ...
              discovery: {
                name: 'Discovery',
                kills: discoveryGetter(val, 'kills'),
                deaths: discoveryGetter(val, 'death'),
                wins: discoveryGetter(val, 'matchwon'),
                losses: discoveryGetter(val, 'matchlost'),
                matches: discoveryGetter(val, 'matchplayed'),
                playtime: discoveryGetter(val, 'timeplayed'),
              }
            }
          },
          pve: {
